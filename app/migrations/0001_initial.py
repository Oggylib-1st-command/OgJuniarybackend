# Generated by Django 4.2 on 2023-08-28 18:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('main', models.CharField(blank=True, max_length=50, null=True, verbose_name='Главный жанр')),
                ('name', models.ManyToManyField(blank=True, max_length=150, to='app.genre')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genres', models.ManyToManyField(blank=True, related_name='genres', to='app.genre', verbose_name='Поджанры')),
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Кто забронировал')),
            ],
            options={
                'verbose_name': 'Книга',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.URLField(blank=True, null=True, verbose_name='Ссылка на фото акка')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('book', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='app.book', verbose_name='Книга')),
